...
export default function Home() {
  return (
    <section className="flex flex-col items-center justify-center px-8 py-16 gap-12 min-h-screen text-center">
      ...
      <h1 className="text-[56px] md:text-[64px] font-semibold tracking-[-0.03em] leading-tight mb-8">Clement PAPILLON</h1>
        <h2 className="text-4xl font-bold mb-4">Bienvenue sur mon PortFolio</h2>
        <p className="text-2xl font-light mb-6">
          Je suis <span className="font-semibold">Technicien du système d&apos;information en alternance</span> en deuxième année de BTS SIO option SISR en alternance.
        </p>
        <Link
          href="/about"
